...
public final class QuantifiedCommand {
        ...
        try {
            dispatcher.register(Commands.literal("quantified")
                ...
                .then(Commands.literal("dev")
                    ...
                    .then(Commands.literal("vulkan-probe").executes(QuantifiedCommand::developerVulkanProbe)))
            );
        } catch (Throwable t) {
    ...
    private static int gpuStatus(CommandContext<CommandSourceStack> context) {
        ...
        sendInfo(context.getSource(), "Preferred: " + GpuBackendRouter.getDefaultPreference().name() + " | Active: " + activeBackend.name());
