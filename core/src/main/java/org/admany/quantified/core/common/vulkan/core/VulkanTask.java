...
public abstract class VulkanTask<T> {
    ...
    protected VulkanTask(Builder<T> builder) {
        this(builder.modId, builder.name, builder.taskKey, builder.cpuFallback, builder.timeout);
    }

    protected VulkanTask(String modId, String name, long taskKey, Supplier<T> cpuFallback, Duration timeout) {
    ...
    public abstract T executeOnGPU(VulkanContext context);
    ...
    public abstract static class Builder<T> {
        ...
        public abstract VulkanTask<T> build();
    }
}
